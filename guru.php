  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            TAMBAH DATA GURU <i class="fas fa-plus-square mr-2"></i>
            </button>
                    ...
                    <form class="form-group" action="" method="post">
                      <ul>
                         <li><label for="nama">Nama lengkap</label></li>
                          ...
                          <li><label for="nip">NIP</label></li>
                              <input type="text" name="nip" class="form-control" id="nip" placeholder="masukan nip anda">
                          ...
                          <li><label for="mata_pelajaran">Mata Pelajaran</label></li>
                              <input type="text" name="mata_pelajaran" class="form-control" id="mata_pelajaran" placeholder="masukan mata pelajaran anda"></li>            
                      </ul>
                  </div>
            ...
            <table class="table table-striped table-bordered text-center">
              ...
              <?php $i= 1; ?>
                ...
                <tr>
                  ...
                  <td><a href="detailguru.php? id=<?= $gru["id"];?>" class="btn btn-primary mt-2 text-center">Detail</a></td>
                  <td><a href="ubahguru.php? id=<?= $gru["id"];?>" onclick= "return confirm('Apakah anda yakin ingin mengubah?')"><i class="fas fa-edit bg-info text-white p-2 rounded" data-toggle="tooltip" title="edit"></i></a></td>
                  <td><a href="hapusguru.php? id=<?= $gru["id"];?>" onclick= "return confirm('Apakah anda yakin ingin menghapus?')"><i class="fas fa-trash-alt bg-success text-white p-2 rounded" data-toggle="tooltip" title="Delete"></i></a></td>
                </tr>
                <?php $i++; ?>
                <?php endforeach; ?>
            </table>
